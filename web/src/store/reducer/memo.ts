...
const memoSlice = createSlice({
  ...
  reducers: {
    ...
    setCommentCnt: (state, action: PayloadAction<Record<string, number>>) => {
      return {
        ...state,
...
export const { updateLoadingStatus, upsertMemos, createMemo, patchMemo, deleteMemo, setCommentCnt } = memoSlice.actions;
