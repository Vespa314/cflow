...
const Header = () => {
  ...
  const cflowNavLink: NavLinkItem = {
    id: "header-flow",
    path: "/",
    title: t("card-chat.title"),
    icon: <Icon.Cat className="mr-3 w-6 h-auto opacity-70" />,
    target: "_blank",
  };
  ...
  const navLinks: NavLinkItem[] = user
    ? [homeNavLink, dailyReviewNavLink, resourcesNavLink, archivedNavLink, settingNavLink]
    : [authNavLink];
